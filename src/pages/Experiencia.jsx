...
export const Experiencia = () => {
  return (
    <>
      <div className="bg-menuheader2 bg-opacity-80 ">
        <div
          id="experiencia"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-6  container mx-auto">
          <div className="flex-row px-8 md:block hidden h-full">
            <ParallaxWebs />
          </div>
          <div className="flex-row justify-center px-8">
            ...
            <div className="">
              <a href="" target="_blank" rel="noreferrer">
                <div
                  className="mt-10 h-10 flex items-center justify-center px-4 font-semibold rounded-full bg-topettegreen hover:bg-topettegreenhover text-black cursor-pointer"
                  type="submit"
                >
                  <AiFillFilePdf className="text-1xl mr-2" /> Download CV
                </div>
              </a>
            </div>
          </div>
